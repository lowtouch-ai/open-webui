...
class TestVaultUtils:
    ...
    def test_format_secret_key_common(self):
        ...
        assert key == "users/user123/common_api_key"
    ...
    def test_format_secret_key_agent_specific(self):
        ...
        assert key == "users/user123/agent456_api_key"
    ...
    def test_format_secret_key_default(self):
        ...
        assert key == "users/user123/default_api_key"
    ...
    def test_encrypt_decrypt_value(self):
        ...
        assert encrypted != original_value  # Ensure it's actually encrypted
    ...
    def test_get_connection_success(self, mock_get_client):
        ...
        mock_client.get_secret.return_value = {"value": encrypted_value}
        mock_get_client.return_value = mock_client
...
class TestAgentConnectionsAPI:
    ...
    def test_create_connection_invalid_name(self, mock_get_user, client):
        ...
        connection_data = {
            "key_name": "invalid name!",  # Contains space and special char
            "key_value": "secret_value",
            "agent_id": "agent123",
            "is_common": False
        }
